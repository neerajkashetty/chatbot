 ...
 return(
  ...
  <img src={user} height={24} width={24} alt="" /> {/* Example of how to import the svgs into the code*/}
    ...
    <Menu as='div' className='bg-gray-600/50 shadow-md rounded-md hover: cursor-pointer flex justify-between w-36 h-10 mt-5 ml-20 absolute'>
      <div>
      <Menu.Button className='flex font-bold text-gray-200 ml-6 mt-3 text-sm text-left w-full mb-4'> {username.user}
      <div className='ml-1 '>
      ...
      <div className='ml-2'>
      <svg className="ml-8"xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeidth="1.5" stroke="currentColor" class="w-5 h-5">
