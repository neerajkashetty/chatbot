      ...
      <div className="text-sm p-1 text-black dark:text-gray-400 font-semibold">Today</div>
      {
        istrue && (
            chats.map((chat, index) => (
              <div className="flex justify-start group dark:hover:bg-zinc-700 hover:bg-gray-400 scroll-smooth dark:text-gray-200 text-black  w-full rounded-lg text-sm p-2">
              <button onClick={()=> setConversationId(1, chat.conversationid)} key={index} className="w-full text-start">
